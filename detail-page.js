...
const visualProfiles = {
  "bespoke-software": ["/assets/raco-visual-software.jpg", "coral", "editorial"], "product-development": ["/assets/raco-visual-software.jpg", "coral", "split"], "web-mobile": ["/assets/raco-visual-commerce.jpg", "blue", "poster"], "cloud-modernisation": ["/assets/raco-visual-data.jpg", "indigo", "technical"], "qa-devops": ["/assets/raco-visual-data.jpg", "blue", "split"],
  "ai-transformation": ["/assets/raco-visual-ai.jpg", "magenta", "poster"], "private-ai-rag": ["/assets/raco-visual-ai.jpg", "magenta", "technical"], "agent-development": ["/assets/raco-visual-ai.jpg", "wine", "split"], "voice-computer-vision": ["/assets/raco-industrial-ai.jpg", "coral", "technical"], "data-engineering": ["/assets/raco-visual-data.jpg", "indigo", "editorial"],
...
if (detailTarget) {
  ...
  detailTarget.innerHTML = `
    ...
    <section class="feature-split"><div class="feature-media"><img src="/assets/raco-software-delivery.jpg" alt="RACO cross-functional delivery workshop" /></div><div class="feature-copy"><p class="eyebrow"><span></span> Why RACO</p><h2>Software depth.<br /><em>AI built in.</em></h2><p>${page.fit}</p><ul class="feature-list"><li>Senior technical and delivery ownership</li><li>Security, quality and deployment designed from the start</li><li>Working outcomes and visible decisions throughout</li><li>Knowledge transfer and long-term operational readiness</li></ul></div></section>
    ...
    <section class="page-cta"><h2>Bring us the workflow<br /><em>worth changing.</em></h2><div><p>We will recommend the right first move, team and delivery shape.</p><a class="button button-dark" href="/contact/">Start a project <span>↗</span></a></div></section>`;
}
